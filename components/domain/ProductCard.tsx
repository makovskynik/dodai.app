...
import { PlacementBadge, ProductDayBadge } from "@/components/ui/Badge";
...
export function ProductCard({ product, href, vote }: ProductCardProps) {
  ...
  return (
    <article className="group relative flex h-full flex-col rounded-card border border-line bg-surface p-6 shadow-soft transition-colors hover:border-ink/20 hover:bg-canvas/40">
